CREATE TABLE "produkt" (
  "produkt_id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE "zakaznik" (
  "zakaznik_id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "jmeno" varchar(255) NOT NULL,
...
CREATE TABLE "objednavka" (
  "objednavka_id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "zakaznik_id" int,
...
CREATE TABLE "objednavka_polozka" (
  "objednavka_polozka_id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "objednavka_id" int,
  "produkt_id" int,
...
CREATE TABLE "zaplaceni" (
  "zaplaceni_id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "objednavka_id" int,
...
CREATE TABLE "recenze" (
  "recenze_id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "zakaznik_id" int,
  "produkt_id" int,
...
CREATE TABLE "slevovy_kupony" (
  "sleva_id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE "seznam_prani" (
  "seznam_id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "zakaznik_id" int,
  "produkt_id" int,
...
CREATE TABLE "doprava" (
  "doprava_id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "jmeno" varchar(255) NOT NULL,
  "cena" float,
...
CREATE TABLE "sklad" (
  "sklad_id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
